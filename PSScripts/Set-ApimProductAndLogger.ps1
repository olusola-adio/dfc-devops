...
.EXAMPLE
Set-ApimProductAndLogger -ApimResourceGroup olu-foo-shared-rg -InstanceName dfc-foo-shared-apim -ApiId barapi -ApiProductId bar-product -ApimLoggerName bar-logger
#>
[CmdletBinding()]
param(
