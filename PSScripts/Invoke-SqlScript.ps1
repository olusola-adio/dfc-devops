...
.EXAMPLE
Set-SqlLoginPassword -SQLServerFqdn dwp-foo-bar-sql.database.windows.net -SQLDatabase dwp-foo-bar-db -SQLAdminUsername sa -SQLAdminPassword password1 SQLScript C:\Path\To\Script.sql
