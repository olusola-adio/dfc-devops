...
.EXAMPLE
Set-ApimProductAndLogger -ApimResourceGroup dwp-foo-shared-rg -InstanceName dfc-foo-shared-apim -ApiId barapi -ApiProductId bar-product -ApimLoggerName bar-logger
#>
[CmdletBinding()]
param(
