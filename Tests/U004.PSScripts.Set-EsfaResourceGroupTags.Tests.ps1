...
Describe "Set-EsfaResourceGroupTags unit tests" -Tag "Unit" {
    ...
    Mock Get-AzureRmResourceGroup { [PsCustomObject]
        @{
            ...
            Location = "westeurope"
            Tags = @{"Parent Business" =  "Logion Limited"; "Service Offering" = "Digital First Career Service (DFCS) Website"; "Environment" = "Dev/Test"} 
        }
    }
    ...
    It "Should do nothing if a resource group exists with matching tags" {
        ...
        .\Set-EsfaResourceGroupTags -ResourceGroupName "dfc-foobar-rg" -Environment "Dev/Test" -ParentBusiness "Logion Limited" -ServiceOffering "Digital First Career Service (DFCS) Website"
    ...
    It "Should update existing resource group if group exists with different tags" {
        ...
        .\Set-EsfaResourceGroupTags -ResourceGroupName "dfc-foobar-rg" -Environment "Dev/Test" -ParentBusiness "Logion Limited" -ServiceOffering "Digital First Career Service (DFCS) Website (PP)"
    ...
    It "Should create new resource group if group doesn't exists" {
        ...
        .\Set-EsfaResourceGroupTags -ResourceGroupName "dfc-barfoo-rg" -Environment "Dev/Test" -ParentBusiness "Logion Limited" -ServiceOffering "Digital First Career Service (DFCS) Website (PP)"
